...
Avoid diverting attention from the exciting Blazor challenge, have a read here if more detail is required for the extension method. https://www.c-sharpcorner.com/blogs/fetching-values-from-enum-in-c-sharp
